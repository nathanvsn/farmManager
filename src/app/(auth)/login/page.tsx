    ...
    return (
        <div className="flex h-screen items-center justify-center bg-gray-900 text-white">
            <div className="w-full max-w-md p-8 bg-gray-800 rounded-lg shadow-xl border border-gray-700">
                <h2 className="text-3xl font-bold mb-6 text-center text-blue-500">Acessar Fazenda</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded transition transform hover:scale-[1.02]">
                        Entrar
                    </button>
                </form>

                <p className="mt-6 text-center text-gray-500 text-sm">
                    Ainda não tem terras? <Link href="/register" className="text-blue-500 hover:underline">Registrar</Link>
                </p>
            </div>
        </div>
    );
